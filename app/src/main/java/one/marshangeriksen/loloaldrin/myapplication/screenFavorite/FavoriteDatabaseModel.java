package one.marshangeriksen.loloaldrin.myapplication.screenFavorite;
...
class FavoriteDatabaseModel extends BaseDatabaseModel {

    FavoriteDatabaseModel(Context context) {
        super(context);
    }

    List<Word> getAllFavoriteWords() {
        List<Word> words = new ArrayList<>();
        String query = "SELECT * FROM " + TABLE_WORD+" WHERE " + KEY_FAVORITE+" = "+" 1 "
