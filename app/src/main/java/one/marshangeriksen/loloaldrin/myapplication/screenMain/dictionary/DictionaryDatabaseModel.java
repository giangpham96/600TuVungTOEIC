package one.marshangeriksen.loloaldrin.myapplication.screenMain.dictionary;
...
class DictionaryDatabaseModel extends BaseDatabaseModel {
    DictionaryDatabaseModel(Context context) {
        super(context);
    }
